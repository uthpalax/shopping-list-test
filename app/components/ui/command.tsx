  ...
  return (
    ...
    >
      <CommandPrimitive.Input
        ...
        className={cn(
          "placeholder:text-muted-foreground flex h-10 w-full py-3 text-sm outline-hidden",
          className
        )}
        {...props}
      />
